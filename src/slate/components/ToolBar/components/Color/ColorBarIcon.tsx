...
const ColorBarIcon: React.FC<{
  ...
  return (
    <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3633">
      <path
      ...
      <path
        ...
        fill={`${fontColor}`}
      ></path>
      <path d="M342.016 512h341.333333v85.333333h-341.333333v-85.333333z" p-id="3637" fill={`${fontColor}`}></path>
    </svg>
  )
}

export default ColorBarIcon
